    ...
    return (
        <>
            <div
                ...
                className={`group transition-all flex flex-col cursor-pointer justify-end relative top-0 hover:top-4 hover:brightness-90 brightness-100 go-back-card p-4 rounded-lg bg-${color}`}
